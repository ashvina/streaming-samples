...
public class RandomSentenceGenerator {
  ...
  public String nextSentence(int desiredSentenceSize, double skewPercent) {
  ...
  public String nextWord(double skewPercent) {
    if (skewPercent > 0 && (rand.nextDouble() * 100) < skewPercent) {
      return "skew ";
    } else {
